...
{
    const string tmpIconPath = "Externals/UnityAutoIconBuilder/Generated/tmpIcon.png";
    const string configImagePrefabPath = "Assets/Externals/UnityAutoIconBuilder/Res/ConfigrationImageGenSystem.prefab";
    ...
    public static void GenerateConfigrationImage()
    {
        ...
        var iconGenPrefab = AssetDatabase.LoadAssetAtPath<GenSystemSupporter>(configImagePrefabPath);
        var iconGen = Object.Instantiate(iconGenPrefab);

        // バージョン番号
        string verStr = Application.version;
